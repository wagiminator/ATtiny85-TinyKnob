 ...
 */
#define  USB_CFG_DEVICE_ID       0xdf, 0x05 //0xdb, 0x27
 ...
 */
#define USB_CFG_VENDOR_NAME     'w', 'a', 'g', 'i', 'm', 'i', 'n', 'a', 't', 'o', 'r'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     't', 'i', 'n', 'y', 'K', 'n', 'o', 'b'
 ...
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    25  /* total length of report descriptor */
